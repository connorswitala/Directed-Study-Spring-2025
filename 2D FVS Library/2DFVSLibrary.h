...
//pair<Matrix1D, double> solveMiddleLine(Matrix2D& U, Matrix U_inlet, Matrix2D& dU_old, const Grid& grid, BoundaryCondition toptype, BoundaryCondition bottomtype, const int i, const int Nx, const int Ny, const double dt);
